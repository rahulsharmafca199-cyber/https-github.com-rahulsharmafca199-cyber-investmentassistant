...
//
// For CI/CD (GitHub Actions) the workflow reads the four values from
// repository secrets and sets them as environment variables so that
// the Properties block below falls through to the env-var fallback.
// ---------------------------------------------------------------------------
...
android {
    namespace = "com.example.investmentiq"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.investmentiq"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
